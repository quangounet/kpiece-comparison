...
class DensoProjection : public ob::ProjectionEvaluator
{
 public:
 DensoProjection(const ob::StateSpace* sSpace, RobotBasePtr probot,
	...
	/* else if (_projectionType == 3) */
	/*     project3(state, projection); */
    }
